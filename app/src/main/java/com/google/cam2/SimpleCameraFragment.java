...
import com.google.cam2.camera.CameraUtils;
import com.google.cam2.camera.PictureTransaction;
import com.google.cam2.camera.SimpleCameraHost;
 ...
 * </ul>
 */
public class SimpleCameraFragment extends com.google.cam2.camera.CameraFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnFlash = (ImageButton) root.findViewById(R.id.sc_btn_flash);
    ...
    void resetButtons() {
        ...
        if (btnRecordVideo != null) {
            btnRecordVideo.setVisibility(VISIBLE);
