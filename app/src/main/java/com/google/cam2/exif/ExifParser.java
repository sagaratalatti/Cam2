...
public class ExifParser {
     ...
     * {@link #registerForTagValue(com.google.cam2.exif.ExifTag)} previously. Call {@link #getTag()}
    ...
    private com.google.cam2.exif.ExifTag mTag;
    private ImageEvent mImageEvent;
    private int mStripCount;
    private com.google.cam2.exif.ExifTag mStripSizeTag;
    private com.google.cam2.exif.ExifTag mJpegSizeTag;
    ...
    private boolean isIfdRequested(int ifdType) {
        switch (ifdType) {
            case com.google.cam2.exif.IfdId.TYPE_IFD_0:
                return (mOptions & OPTION_IFD_0) != 0;
            case com.google.cam2.exif.IfdId.TYPE_IFD_1:
                return (mOptions & OPTION_IFD_1) != 0;
            case com.google.cam2.exif.IfdId.TYPE_IFD_EXIF:
                return (mOptions & OPTION_IFD_EXIF) != 0;
            case com.google.cam2.exif.IfdId.TYPE_IFD_GPS:
                return (mOptions & OPTION_IFD_GPS) != 0;
            case com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY:
    ...
    private ExifParser(InputStream inputStream, int options, ExifInterface iRef)
        ...
        mIfdType = com.google.cam2.exif.IfdId.TYPE_IFD_0;
        if (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_0) || needToParseOffsetsInCurrentIfd()) {
            registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_0, offset);
    ...
    protected int next() throws IOException, ExifInvalidFormatException {
        ...
        if (offset < endOfTags) {
            ...
            if (mIfdType == com.google.cam2.exif.IfdId.TYPE_IFD_0) {
                long ifdOffset = readUnsignedLong();
                if (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_1) || isThumbnailRequested()) {
                    if (ifdOffset != 0) {
                        registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_1, ifdOffset);
                    }
                }
            } else {
                int offsetSize = 4;
        ...
        while (mCorrespondingEvent.size() != 0) {
            ...
            if (event instanceof IfdEvent) {
                ...
                mTag = tagEvent.tag;
                if (mTag.getDataType() != com.google.cam2.exif.ExifTag.TYPE_UNDEFINED) {
    ...
    protected void skipRemainingTagsInCurrentIfd() throws IOException, ExifInvalidFormatException {
        ...
        if (mIfdType == com.google.cam2.exif.IfdId.TYPE_IFD_0
                && (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_1) || isThumbnailRequested())) {
            if (ifdOffset > 0) {
                registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_1, ifdOffset);
            }
        }
    ...
    private boolean needToParseOffsetsInCurrentIfd() {
        switch (mIfdType) {
            case com.google.cam2.exif.IfdId.TYPE_IFD_0:
                return isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_EXIF) || isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_GPS)
                        || isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY)
                        || isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_1);
            case com.google.cam2.exif.IfdId.TYPE_IFD_1:
                return isThumbnailRequested();
            case com.google.cam2.exif.IfdId.TYPE_IFD_EXIF:
                // The offset to interoperability IFD is located in Exif IFD
                return isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY);
            default:
                return false;
        }
    }
     ...
     * {@link com.google.cam2.exif.ExifTag#hasValue()} to check if the tag contains value. If there
     * is no value,call {@link #registerForTagValue(com.google.cam2.exif.ExifTag)} to have the parser
     ...
     *
     * @see #registerForTagValue(com.google.cam2.exif.ExifTag)
     * @see #read(byte[])
     ...
     */
    protected com.google.cam2.exif.ExifTag getTag() {
        return mTag;
    }
     ...
     * @see #EVENT_VALUE_OF_REGISTERED_TAG
     */
    protected void registerForTagValue(com.google.cam2.exif.ExifTag tag) {
    ...
    private com.google.cam2.exif.ExifTag readTag() throws IOException, ExifInvalidFormatException {
        ...
        if (!com.google.cam2.exif.ExifTag.isValidType(dataFormat)) {
            Log.w(TAG, String.format("Tag %04x: Invalid data type %d", tagId, dataFormat));
            mTiffStream.skip(4);
            return null;
        }
        // TODO: handle numOfComp overflow
        com.google.cam2.exif.ExifTag tag = new com.google.cam2.exif.ExifTag(tagId, dataFormat, (int) numOfComp, mIfdType,
                ((int) numOfComp) != com.google.cam2.exif.ExifTag.SIZE_UNDEFINED);
        ...
        if (dataSize > 4) {
            ...
            // Read the data here.
            if ((offset < mIfd0Position) && (dataFormat == com.google.cam2.exif.ExifTag.TYPE_UNDEFINED)) {
     ...
     */
    private void checkOffsetOrImageTag(com.google.cam2.exif.ExifTag tag) {
        ...
        if (tid == TAG_EXIF_IFD && checkAllowed(ifd, ExifInterface.TAG_EXIF_IFD)) {
            if (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_EXIF)
                    || isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY)) {
                registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_EXIF, tag.getValueAt(0));
            }
        } else if (tid == TAG_GPS_IFD && checkAllowed(ifd, ExifInterface.TAG_GPS_IFD)) {
            if (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_GPS)) {
                registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_GPS, tag.getValueAt(0));
            }
        } else if (tid == TAG_INTEROPERABILITY_IFD
                && checkAllowed(ifd, ExifInterface.TAG_INTEROPERABILITY_IFD)) {
            if (isIfdRequested(com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY)) {
                registerIfd(com.google.cam2.exif.IfdId.TYPE_IFD_INTEROPERABILITY, tag.getValueAt(0));
            }
            ...
            if (isThumbnailRequested()) {
                if (tag.hasValue()) {
                    for (int i = 0; i < tag.getComponentCount(); i++) {
                        if (tag.getDataType() == com.google.cam2.exif.ExifTag.TYPE_UNSIGNED_SHORT) {
    ...
    protected void readFullTagValue(com.google.cam2.exif.ExifTag tag) throws IOException {
        // Some invalid images contains tags with wrong size, check it here
        short type = tag.getDataType();
        if (type == com.google.cam2.exif.ExifTag.TYPE_ASCII || type == com.google.cam2.exif.ExifTag.TYPE_UNDEFINED ||
                type == com.google.cam2.exif.ExifTag.TYPE_UNSIGNED_BYTE) {
        ...
        switch (tag.getDataType()) {
            ...
            case com.google.cam2.exif.ExifTag.TYPE_UNSIGNED_RATIONAL: {
                com.google.cam2.exif.Rational value[] = new com.google.cam2.exif.Rational[tag.getComponentCount()];
                for (int i = 0, n = value.length; i < n; i++) {
                ...
                break;
            case com.google.cam2.exif.ExifTag.TYPE_UNSIGNED_SHORT: {
     ...
     * reading values of type {@link com.google.cam2.exif.ExifTag#TYPE_ASCII}.
     */
     ...
     * values of type {@link com.google.cam2.exif.ExifTag#TYPE_ASCII}.
     */
    ...
    /**
     * Reads value of type {@link com.google.cam2.exif.ExifTag#TYPE_UNSIGNED_SHORT} from the
     * InputStream.
     */
    ...
    /**
     * Reads value of type {@link com.google.cam2.exif.ExifTag#TYPE_UNSIGNED_LONG} from the
     * InputStream.
     */
    ...
    /**
     * Reads value of type {@link com.google.cam2.exif.ExifTag#TYPE_UNSIGNED_RATIONAL} from the
     * InputStream.
     */
    protected com.google.cam2.exif.Rational readUnsignedRational() throws IOException {
        long nomi = readUnsignedLong();
        long denomi = readUnsignedLong();
        return new com.google.cam2.exif.Rational(nomi, denomi);
    }

    /**
     * Reads value of type {@link com.google.cam2.exif.ExifTag#TYPE_LONG} from the InputStream.
     */
    ...
    /**
     * Reads value of type {@link com.google.cam2.exif.ExifTag#TYPE_RATIONAL} from the InputStream.
     */
    protected com.google.cam2.exif.Rational readRational() throws IOException {
        int nomi = readLong();
        int denomi = readLong();
    ...
    private static class ExifTagEvent {
        com.google.cam2.exif.ExifTag tag;
        boolean isRequested;
