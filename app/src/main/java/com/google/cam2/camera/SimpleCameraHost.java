...
public class SimpleCameraHost implements com.google.cam2.camera.CameraHost {
  private static final String[] SCAN_TYPES= { "image/jpeg" };
  private Context ctxt=null;
  private int cameraId=-1;
  private com.google.cam2.camera.DeviceProfile profile=null;
  ...
  @Override
  public com.google.cam2.camera.DeviceProfile getDeviceProfile() {
    if (profile == null) {
  ...
  private void initDeviceProfile(Context ctxt) {
    profile= com.google.cam2.camera.DeviceProfile.getInstance(ctxt);
  }

  @Override
  public Camera.Size getPictureSize(PictureTransaction xact,
                                    Camera.Parameters parameters) {
    return(com.google.cam2.camera.CameraUtils.getLargestPictureSize(this, parameters));
  }
