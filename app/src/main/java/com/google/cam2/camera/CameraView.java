...
package com.google.cam2.camera;
...
import com.google.cam2.camera.CameraHost.FailureReason;
...
public class CameraView extends ViewGroup implements AutoFocusCallback {
  ...
  private com.google.cam2.camera.CameraHost host=null;
  ...
  public com.google.cam2.camera.CameraHost getHost() {
    return(host);
  }

  // must call this after constructor, before onResume()

  public void setHost(com.google.cam2.camera.CameraHost host) {
    this.host=host;
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (width > 0 && height > 0) {
      if (camera != null) {
        ...
        try {
          if (getHost().getRecordingHint() != com.google.cam2.camera.CameraHost.RecordingHint.STILL_ONLY) {
  ...
  public void record() throws Exception {
    ...
    if (displayOrientation != 0 && displayOrientation != 90) {
      throw new UnsupportedOperationException(
  ...
  public void initPreview(int w, int h, boolean firstRun) {
    if (camera != null) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
        parameters.setRecordingHint(getHost().getRecordingHint() != com.google.cam2.camera.CameraHost.RecordingHint.STILL_ONLY);
      }
